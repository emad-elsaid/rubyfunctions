class User < ApplicationRecord
  ...
  has_many :followership, foreign_key: :followee_id, inverse_of: :follower, dependent: :destroy
  has_many :followeeship, class_name: :Followership, foreign_key: :follower_id,
                          inverse_of: :followee, dependent: :destroy

  has_many :followers, class_name: :User, through: :followership
  has_many :followees, class_name: :User, through: :followeeship
